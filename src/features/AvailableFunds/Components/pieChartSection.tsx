...
interface IPichart {
    ...
    formatedBankDisplay: any,
    formatedfundDisplay: any
}
                ...
                <Grid size={12} >
                    <Stack spacing={1}>
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", color: palette.text.secondary }}>
                            <Typography variant="body2">{formatedBankDisplay}</Typography>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", color: palette.text.secondary }}>
                            <Typography variant="body2">{formatedfundDisplay}</Typography>
                            <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
