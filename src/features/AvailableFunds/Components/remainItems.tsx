...
const RemainingItemsection = ({ valueType,
    ...
    setIsDetailsExpanded }: { valueType: string, remainingBankItems: IRemainProps[], remainingFundItems: IRemainProps[], isFundDetailsExpanded: any, setIsDetailsExpanded: any }) => {
