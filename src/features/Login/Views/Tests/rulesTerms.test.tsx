...
describe('RulesAndTerms', () => {
  ...
  it('renders the RulesAndTerms component correctly with all content', () => {
    ...
    expect(mainLogo).toHaveStyle('width: 71px');
    expect(mainLogo).toHaveStyle('height: 22px');
    ...
    expect(backArrowImage).toHaveStyle('width: 24px');
    expect(backArrowImage).toHaveStyle('height: 24px');
