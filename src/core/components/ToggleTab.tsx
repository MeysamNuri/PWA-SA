        ...
        <Box sx={{
            ...
            {options.map((option) => (
                <Button
                    ...
                    sx={{
                        color: value === option.value ? theme.palette.button?.main : theme.palette.text?.secondary,
                        background: value === option.value ? (isDateFilter ? theme.palette.success?.light : theme.palette.background?.paper) : "transparent",
                        ...
                        '&:hover': {
                            background: value === option.value 
                                ? (isDateFilter ? theme.palette.success?.light : theme.palette.background?.paper)
        ...
        >
            {options.map((option, index) => (
                <Button
                    ...
                    sx={{
                        color: value === option.value ? theme.palette.button.main : theme.palette.text.secondary,
                        background: value === option.value ? (isDateFilter ? theme.palette.error.light : theme.palette.background.paper) : theme.palette.background.default,
                        ...
                        minWidth: 'unset',
                        direction: 'rtl',
                        borderLeft: !isDateFilter && index !== 0 ? `1px solid ${theme.palette.background.paper}` : 'none',
                        '&:hover': {
                            background: value === option.value
                                ? (isDateFilter ? theme.palette.error.light : theme.palette.background.paper)
                                : theme.palette.action.hover,
                            boxShadow: 'none',
                        },
                    }}
