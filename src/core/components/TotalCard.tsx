                    ...
                    <React.Fragment key={idx}>
                        <Box sx={{
                            ...
                            >
                                ...
                                {row.unit && <span style={{ fontSize: '12px', color: theme.palette.text.disabled }}>{row.unit}</span>}
                            </Typography>
                        </Box>
                        {idx !== rows.length - 1 && <Divider sx={{ backgroundColor: theme.palette.divider, my: 1 }} />}
                    </React.Fragment>
                ))
            }
        </Box >
