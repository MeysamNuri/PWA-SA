        ...
        >
            ...
            <Box sx={{ px: 1.5 }}>
                ...
                <Box sx={{ bgcolor: palette.background.paper, borderRadius: 3, p: 1 }}>
                    <TitleTotalValue value={totalAssetValue} valueType={valueTypeEnum.available} currencyTab={currencyTab} totalBalanceUOM={totalBalanceUOM} />
                    <PieChartSection
                    ...
                    <Box sx={{ padding: "10px 15px 15px 15px", mb: 2, borderRadius: "10px", border: `1px solid ${palette.divider}` }}>
                        ...
                        <Grid container alignItems="center">
                            <Grid size={12}>
                                <InitialItemsSection
                                    valueType={valueTypeEnum.bank}
                                    initialBankItems={initialBankItems}
                                    initialFundItems={initialFundItems}
                                    currencyTab={currencyTab}
                                />
                    ...
                    <Box sx={{ padding: "10px 15px 15px 15px", mb: 2, borderRadius: "10px", border: `1px solid ${palette.divider}` }}>
                        ...
                        <Grid container alignItems="center">
                            <Grid size={12}>
                                <InitialItemsSection valueType={valueTypeEnum.fund} initialBankItems={initialBankItems} initialFundItems={initialFundItems} currencyTab={currencyTab} />
