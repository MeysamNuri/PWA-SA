...
describe('RemainingItemsection', () => {
    // Test case 1: Renders bank items when expanded with toman currency
    it('should render bank items when expanded with toman currency', () => {
        render(
    ...
    // Test case 2: Renders bank items when expanded with dollar currency
    it('should render bank items when expanded with dollar currency', () => {
        render(
            <RemainingItemsection
                valueType="bank"
                remainingBankItems={mockBankItems}
    ...
    // Test case 3: Hides items when collapsed
    ...
    // Test case 4: Toggles the expanded state on button click
    ...
    // Test case 5: Renders nothing when data is empty
