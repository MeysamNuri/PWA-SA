...
describe('DebitCreditView', () => {
    ...
    it('displays main cards when list has items', () => {
        ...
        expect(screen.getByTestId('card-header')).toHaveTextContent('Test Customer - ٥٠,٠٠٠ تومان');
    });
    ...
    it('displays correct card rows with data', () => {
        ...
        expect(screen.getByTestId('row-2')).toHaveTextContent('جمع دریافتی: ١٠٠,٠٠٠ تومان');
        expect(screen.getByTestId('row-3')).toHaveTextContent('جمع پرداختی: ٥٠,٠٠٠ تومان');
    });
    ...
    it('displays correct totals when data is undefined', () => {
        ...
        expect(screen.getByTestId('total-row-0')).toHaveTextContent('جمع بدهکاران: 0');
        expect(screen.getByTestId('total-row-1')).toHaveTextContent('جمع بستانکاران: 0');
    });
