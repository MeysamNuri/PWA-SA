...
export default function UserInfo({ userProfileData, serial }: { userProfileData: IUserProfileDataRes | undefined, serial: string }) {
    ...
    return (
        <Paper elevation={0} sx={{ m: 2, borderRadius: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', p: 2, borderBottom: `2px solid ${palette.divider}` }}>
            ...
            <Box sx={{ p: 2 }}>
                ...
                <Box sx={{ bgcolor: palette.background.paper, p: 0, border: `1px solid ${palette.divider}`, borderRadius: "12px" }}>
