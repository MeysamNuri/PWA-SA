...
describe('GetInSaleOutOfStockProductsView', () => {
  ...
  it('should render products with correct data and handle card expansion', () => {
    ...
    expect(firstCardRows).toHaveTextContent('قیمت خرید: 800000');
    expect(firstCardRows).toHaveTextContent('قیمت فروش: 1000000');
    expect(firstCardRows).toHaveTextContent('میانگین فروش: 950000');
