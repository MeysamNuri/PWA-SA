...
export interface UnsettledInvoicesData {
    unsettledQuantity: number;
    unsettledAmount: number;
    formattedUnsettledAmount: string | null;
    unsettledAmountUOM: string | null;
}

export interface ISalesBySellerDto {
    sellerCode: string,
    sellerName: string,
    soldPrice: number,
    formattedSoldPrice: string,
...
export interface ISalesBySellerRes {
    salesBySellerDto: ISalesBySellerDto[]
}
export interface ITopCustomersByPurchaseRes {
    customerCode: string,
    customerName: string,
    soldPrice: number,
    formattedSoldPrice: string,
...
export type ComponentMap = Record<PageNameItem, ComponentEntry>;


export type PageNameItem =
    | 'salesrevenue'
    | 'availablefunds'
    | 'debitcredit'
    | 'cheques'
